...
public class FoodAnalyzerClient {
    private static final String QUIT_COMMAND_TEXT = "quit";
    ...
    public static void main(String[] args) {
        ...
        try (SocketChannel socketChannel = SocketChannel.open();
            ...
            while (true) {
                ...
                if (QUIT_COMMAND_TEXT.equals(message)) {
            ...
            System.out.println("There is a problem with the network communication.Try again later.");
        }
    }
}
